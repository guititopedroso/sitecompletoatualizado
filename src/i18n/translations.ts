...
export const translations: Translations = {
  pt: {
    ...
    hero_subtitle: "Atividades e experiências náuticas em Setúbal. Vive momentos inesquecíveis na costa de Setúbal e Tróia com os nossos passeios de barco e aventuras.",
    ...
    about_desc: "A Royal Coast é uma empresa jovem e energética, focada em proporcionar momentos de pura liberdade através de passeios de barco e atividades náuticas na costa de Setúbal. Com embarcações e equipamentos de última geração e uma equipa apaixonada, garantimos diversão com total segurança nas tuas aventuras em Tróia e Arrábida.",
    ...
    exp_desc: "Desde emocionantes passeios de jet ski a passeios de barco e experiências ao pôr do sol, temos o pacote perfeito para as tuas aventuras em Setúbal, Tróia e Arrábida.",
    ...
    contact_desc: "Entra em contacto para passeios de barco ou outras atividades náuticas e reserva já a tua experiência em Setúbal.",
