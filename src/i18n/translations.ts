...
export const translations: Translations = {
  pt: {
    ...
    hero_subtitle: "Aluga a tua mota de água e vive uma experiência inesquecível na costa de Setúbal.",
    ...
    about_desc: "A Vale Jet é uma empresa jovem e energética, focada em proporcionar momentos de pura liberdade na costa de Setúbal. Com equipamento de última geração e uma equipa apaixonada, garantimos diversão com total segurança.",
    ...
    safety_title: "A tua segurança é prioridade",
    safety_desc: "Diversão sem preocupações. Tudo pensado ao detalhe para que aproveites ao máximo.",
    safety_s1_title: "Coletes Incluídos",
    safety_s1_desc: "Coletes salva-vidas para todos os participantes.",
    safety_s2_title: "Briefing Completo",
    safety_s2_desc: "Explicação detalhada antes de cada partida.",
    safety_s3_title: "Equipamento Certificado",
    safety_s3_desc: "Motas de água com manutenção rigorosa.",
    safety_s4_title: "Seguro Incluído",
    safety_s4_desc: "Cobertura total para a tua tranquilidade.",
    ...
    contact_hours_1: "Maio – Outubro: 9h – 19h",
    contact_hours_2: "Restantes meses: sob marcação",
    contact_location: "Localização",
    contact_loc_1: "Praia de Albarquel, Setúbal",
    contact_loc_2: "Costa da Serra da Arrábida",
  ...
  en: {
    ...
    hero_subtitle: "Rent your jet ski and live an unforgettable experience on the coast of Setúbal.",
    ...
    about_desc: "Vale Jet is a young and energetic company, focused on providing moments of pure freedom on the coast of Setúbal. With state-of-the-art equipment and a passionate team, we guarantee fun with total safety.",
    ...
    safety_desc: "Fun without worries. Everything thought through so you can enjoy to the fullest.",
    safety_s1_title: "Life Jackets Included",
    safety_s1_desc: "Life jackets for all participants.",
    safety_s2_title: "Full Briefing",
    safety_s2_desc: "Detailed explanation before every departure.",
    safety_s3_title: "Certified Equipment",
    safety_s3_desc: "Jet skis with rigorous maintenance.",
    safety_s4_title: "Insurance Included",
    safety_s4_desc: "Full coverage for your peace of mind.",
    ...
    contact_instagram: "Instagram",
    contact_hours: "Hours",
    contact_hours_1: "May – October: 9am – 7pm",
    contact_hours_2: "Other months: by appointment",
    contact_location: "Location",
    contact_loc_1: "Albarquel Beach, Setúbal",
    contact_loc_2: "Arrábida Mountain Coast",
  ...
  de: {
    ...
    hero_subtitle: "Miete deinen Jetski und erlebe ein unvergessliches Abenteuer an der Küste von Setúbal.",
    ...
    about_desc: "Vale Jet ist ein junges und energiegeladenes Unternehmen, das sich darauf konzentriert, Momente purer Freiheit an der Küste von Setúbal zu bieten. Mit modernster Ausrüstung und einem leidenschaftlichen Team garantieren wir Spaß mit höchster Sicherheit.",
    ...
    safety_desc: "Spaß ohne Sorgen. Alles bis ins Detail durchdacht, damit du das Maximum genießen kannst.",
    safety_s1_title: "Schwimmwesten Inklusive",
    safety_s1_desc: "Schwimmwesten für alle Teilnehmer.",
    safety_s2_title: "Vollständiges Briefing",
    safety_s2_desc: "Detaillierte Erklärung vor jeder Abfahrt.",
    safety_s3_title: "Zertifizierte Ausrüstung",
    safety_s3_desc: "Jetskis mit strenger Wartung.",
    safety_s4_title: "Versicherung Inklusive",
    safety_s4_desc: "Volle Deckung für deine Sicherheit.",
    ...
    contact_hours_1: "Mai – Oktober: 9 – 19 Uhr",
    contact_hours_2: "Übrige Monate: nach Vereinbarung",
    contact_location: "Standort",
    contact_loc_1: "Strand Albarquel, Setúbal",
    contact_loc_2: "Küste der Serra da Arrábida",
    contact_form_name: "Name",
  ...
  es: {
    ...
    hero_subtitle: "Alquila tu moto de agua y vive una experiencia inolvidable en la costa de Setúbal.",
    ...
    about_desc: "Vale Jet es una empresa joven y enérgica, enfocada en proporcionar momentos de pura libertad en la costa de Setúbal. Con equipamiento de última generación y un equipo apasionado, garantizamos diversión con total seguridad.",
    ...
    safety_title: "Tu seguridad es prioridad",
    safety_desc: "Diversión sin preocupaciones. Todo pensado al detalle para que disfrutes al máximo.",
    safety_s1_title: "Chalecos Incluidos",
    safety_s1_desc: "Chalecos salvavidas para todos los participantes.",
    safety_s2_title: "Briefing Completo",
    safety_s2_desc: "Explicación detallada antes de cada salida.",
    safety_s3_title: "Equipamiento Certificado",
    safety_s3_desc: "Motos de agua con mantenimiento riguroso.",
    safety_s4_title: "Seguro Incluido",
    safety_s4_desc: "Cobertura total para tu tranquilidad.",
    ...
    contact_hours_1: "Mayo – Octubre: 9h – 19h",
    contact_hours_2: "Resto de meses: con cita previa",
    contact_location: "Ubicación",
    contact_loc_1: "Playa de Albarquel, Setúbal",
    contact_loc_2: "Costa de la Serra da Arrábida",
  ...
  fr: {
    ...
    hero_subtitle: "Louez votre jet ski et vivez une expérience inoubliable sur la côte de Setúbal.",
    ...
    about_desc: "Vale Jet est une entreprise jeune et dynamique, axée sur des moments de pure liberté sur la côte de Setúbal. Avec un équipement de pointe et une équipe passionnée, nous garantissons le plaisir en toute sécurité.",
    ...
    safety_s1_title: "Gilets Inclus",
    safety_s1_desc: "Gilets de sauvetage pour tous les participants.",
    safety_s2_title: "Briefing Complet",
    safety_s2_desc: "Explication détaillée avant chaque départ.",
    safety_s3_title: "Équipement Certifié",
    safety_s3_desc: "Jet skis avec entretien rigoureux.",
    safety_s4_title: "Assurance Incluse",
    safety_s4_desc: "Couverture complète pour votre tranquillité.",
    ...
    contact_hours_1: "Mai – Octobre : 9h – 19h",
    contact_hours_2: "Autres mois : sur rendez-vous",
    contact_location: "Localisation",
    contact_loc_1: "Plage d'Albarquel, Setúbal",
    contact_loc_2: "Côte de la Serra da Arrábida",
  ...
  zh: {
    ...
    hero_title_1: "感受自由",
    hero_title_2: "萨杜河的召唤",
    hero_subtitle: "租一辆水上摩托，在塞图巴尔海岸体验难忘之旅。",
    hero_cta_book: "立即预订",
    ...
    about_title_1: "大海的能量",
    about_title_2: "尽在掌中",
    about_desc: "Vale Jet是一家年轻而充满活力的公司，致力于在塞图巴尔海岸提供纯粹自由的时刻。凭借先进的设备和充满热情的团队，我们确保安全与乐趣并存。",
    about_f1_title: "热爱大海",
    ...
    safety_tag: "安全",
    safety_title: "你的安全是我们的首要任务",
    safety_desc: "无忧的乐趣。每个细节都经过精心考虑，让你尽情享受。",
    safety_s1_title: "含救生衣",
    safety_s1_desc: "为所有参与者提供救生衣。",
    safety_s2_title: "完整安全讲解",
    safety_s2_desc: "每次出发前详细说明。",
    safety_s3_title: "认证设备",
    safety_s3_desc: "经过严格维护的水上摩托。",
    safety_s4_title: "含保险",
    safety_s4_desc: "全面保障让你安心。",
    ...
    contact_instagram: "Instagram",
    contact_hours: "营业时间",
    contact_hours_1: "5月–10月：9:00–19:00",
    contact_hours_2: "其他月份：预约制",
    contact_location: "位置",
    contact_loc_1: "阿尔巴克尔海滩，塞图巴尔",
    contact_loc_2: "阿拉比达山海岸",
