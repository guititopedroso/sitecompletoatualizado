...
const Safety = () => {
  ...
  const items = [
    {
      icon: LifeBuoy,
      title: t("safety_s1_title"),
      desc: t("safety_s1_desc"),
    },
    {
      icon: BookOpen,
      title: t("safety_s2_title"),
      desc: t("safety_s2_desc"),
    },
    {
      icon: BadgeCheck,
      title: t("safety_s3_title"),
      desc: t("safety_s3_desc"),
    },
    {
      icon: ShieldCheck,
      title: t("safety_s4_title"),
      desc: t("safety_s4_desc"),
    },
  ];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {items.map((item, i) => (
                ...
                >
                  ...
                  <h3 className="font-display font-700 text-lg text-primary-foreground mb-2">
                    {item.title}
                  </h3>
